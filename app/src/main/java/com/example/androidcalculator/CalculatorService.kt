...
data class GetOperationsResponse(val uuid: String, val expression:
                                 String, val result: Double, val timestamp: Long)

data class DeleteOperationByIdResponse(val message: String)

data class DeleteAllOperationResponse(val message: String)
...
interface CalculatorService {
    ...
    @Headers("apiKey:8270435acfead39ccb03e8aafbf37c49359dfbbcac4ef4769ae82c9531da0e17")
    @DELETE("operations")
    suspend fun deleteAll() : DeleteAllOperationResponse
